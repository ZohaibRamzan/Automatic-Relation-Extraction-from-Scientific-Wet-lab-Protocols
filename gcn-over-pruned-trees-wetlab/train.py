...
parser.add_argument('--data_dir', type=str, default='dataset/wetlab')
...
print('Type Batch', type(train_batch))
...
loss_batches=[207,430,741,891,1417,1590,1177,1770,698]
